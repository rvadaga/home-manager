# Generated by Powerlevel10k configuration wizard on 2024-12-27 at 18:10 EST.
...
# many icons, fluent, instant_prompt=verbose.# Type `p10k configure` to generate another config.
#
